"""
ResnetPIGCGRU: Physics-Informed Graph Convolutional GRU with Residual Connections.
...
class ResnetPIGCGRU(SpatioTemporalRNN):
    """
    A Physics-Informed Graph Convolutional GRU with Residual Connections.
    
    This is a thin wrapper around SpatioTemporalRNN with rnn_type='GRU' and use_resnet=True.
    ...
    def __init__(self, feature_dim: int, hidden_dim: int, num_gc_layers: int, num_buses: int, rnn_layers: int, dropout: float,
        ...
        super().__init__(
            ...
            embedding_dim=embedding_dim, phi=phi, rnn_type='GRU', use_resnet=True,
