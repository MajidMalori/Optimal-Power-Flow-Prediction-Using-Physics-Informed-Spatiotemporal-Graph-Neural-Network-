"""
PIGCLSTM: Physics-Informed Graph Convolutional LSTM.
...
class PIGCLSTM(SpatioTemporalRNN):
    """
    A Physics-Informed Graph Convolutional LSTM using GraphConvLSTM cells.
    
    This is a thin wrapper around SpatioTemporalRNN with rnn_type='LSTM' and use_resnet=False.
    ...
    def __init__(self, feature_dim: int, hidden_dim: int, num_gc_layers: int, num_buses: int, rnn_layers: int, dropout: float, 
        ...
        super().__init__(
            ...
            embedding_dim=embedding_dim, phi=phi, rnn_type='LSTM', use_resnet=False,
